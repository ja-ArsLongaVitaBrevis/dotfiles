...
# Note: You may want to review and update the LOCATION variable inside install.sh
# before running it if you want to clone the repo to a different directory.
bash install.sh
```
